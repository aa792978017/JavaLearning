package jvm.classloader.HotDeployDemo;

import jvm.classloader.HotDeployDemo.MyClassLoader;

import java.io.File;

public class HotDeployDemo {
    private static final String CLASS_NAME = "jvm.classloader.HotDeployDemo.HelloServiceImpl";  //class名
    private static final String FILE_NAME = "/home/voidcc/桌面/JavaLearning/out/production/JavaLearning/jvm/classloader/HotDeployDemo/HelloServiceImpl.class";  //文件路径
